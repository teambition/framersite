...
leftLine = new Layer width:2, x:leftThreshold, y:80, height:140, backgroundColor: "#D0D3DB"
rightLine = new Layer width:2, x:rightThreshold, y:80, height:140, backgroundColor: "#D0D3DB"
